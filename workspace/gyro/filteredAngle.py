...
setup()
print "Kalibracja: base_x: " + str(base_x_gyro) + " base_y " + str(base_y_gyro) + " base_z " + str(base_z_gyro)
...
while 1:
  ...
  accel_angle_y = math.degrees(math.atan((-1)*accel_x/math.sqrt(accel_y*accel_y + accel_z*accel_z)))#*RADIANS_TO_DEGREES
  accel_angle_x = math.degrees(math.atan(accel_y/math.sqrt(accel_x*accel_x + accel_z*accel_z)))#*RADIANS_TO_DEGREES
  accel_angle_z = 0.0
  ...
  print "ACC " + str(accel_angle_x) + " " + str(accel_angle_y)
  time.sleep(0.005)
